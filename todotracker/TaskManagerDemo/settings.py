"""
Django settings for TaskManagerDemo project.
...
ROOT_URLCONF = 'TaskManagerDemo.urls'
...
WSGI_APPLICATION = 'TaskManagerDemo.wsgi.application'
...
# Specify where to store static files
STATIC_URL = '/static/'
